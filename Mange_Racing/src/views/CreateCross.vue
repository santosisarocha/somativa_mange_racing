...
const fetchImages = async () => {
  try {
    ...
    // Filtra para pegar apenas os itens com title "Cross Rider"
    frenteIMG.value = frenteData.filter(img => img.title === "Cross Rider");
    motorIMG.value = motorData.filter(img => img.title === "Cross Rider");
    rodaFrenteIMG.value = rodaFrenteData.filter(img => img.title === "Cross Rider");
    rodaTraseiraIMG.value = rodaTraseiraData.filter(img => img.title === "Cross Rider");
  } catch (error) {
