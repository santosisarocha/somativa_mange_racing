...
const fetchImages = async () => {
  try {
    ...
    // Filtra para pegar apenas os itens com title "City"
    frenteIMG.value = frenteData.filter(img => img.title === "City");
    motorIMG.value = motorData.filter(img => img.title === "City");
    rodaFrenteIMG.value = rodaFrenteData.filter(img => img.title === "City");
    rodaTraseiraIMG.value = rodaTraseiraData.filter(img => img.title === "City");
  } catch (error) {
